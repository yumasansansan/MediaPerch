...
decoder in the tree, and fails if what it measures is not what this table says. A coverage
...
that declined. **Bold** is the decoder the resolution rules pick when nobody says;
